module.exports = {
  async up(knex) {
    const roleId = "09c04dcf-5a1b-4583-b900-b259fa32dffa"; // standard
    const collection = "images";
    const action = "read";
    const newFields =
      "id,prompt,results,user_created,date_created,status,progress,url,error,upscaled_urls,upscaled";
